...
\paragraph{Funktionale Anforderungen} %TODO generelle Anmerkung: "Funktionale Anforderungen" sollten "Qualitätsanforderungen" heißen
\begin{itemize}
...
\paragraph{Sequenzen von Benutzeraktionen und Systemantworten}
Der Benutzer trägt in einer WebMaske seine einzelnen Verbräuche ein und kann mit einem Klick auf den Button “hochladen” seine Daten der Datenbank hinzufügen, bevor dies geschieht, wird aber überprüft, ob die Daten neu und sinnig sind. %TODO noch automatisches eintragen berücksichtigen
\paragraph{Funktionale Anforderungen}
Noch zu diskutieren.
...
Diese Funktion hat keine hohe Priorität(?) da sie nur für den Vergleich mit dem Durchschnitt relevant ist. %TODO das ist glaube Ich nicht richtig, da wir ohne Immobilie die Verbräuche Niemandem zuschreiben können
\paragraph{Sequenzen von Benutzeraktionen und Systemantworten}
...
\begin{itemize}
	...
	\item ???
\end{itemize}
%TODO entweder ganz entfernen oder richtig machen

\subsubsection{Abomodell ändern}
%TODO auch in den Anhang?
...
\begin{itemize}
	...
	\item \textbf{ABO5} Eine Verbindung zu externen Zahlungsanbietern muss aufgebaut werden. Derzeit ist die Unterstützung von \textit{PayPal}, Lastschrift, Sofort-Überweisung der \textit{Sofort GmbH}, \textit{Klarna} und Kreditkartenzahlungen geplant %TODO ist \textit immer bei Marken? -> dann als Konvention in Einführung
...
\subsubsection{Account verwalten} %TODO sicher, dass das nur der normale Benutzer kann, nicht aber Support oder Admin?
\paragraph{Beschreibung und Priorität}
...
%TODO irgendwie komisch formuliert
\paragraph{Funktionale Anforderungen}
Noch zu diskutieren
