...
\paragraph{Beschreibung und Priorität}
Diese Funktion ermöglicht es dem Nutzer nach Erstellung seines Accounts Änderungen daran vorzunehmen, wie zum Beispiel, seine Adresse nach einem Umzug zu ändern. Außerdem hat der Nutzer hier die Möglichkeit die Daten seines Accounts zu verwalten, also löschen oder anfordern nach DSGVO. Die Priorität sollte hoch eingestuft werden, da wir uns zum einen an die DSGVO halten sollten und zum anderen sichergestellt werden sollte, dass wir relevante Vebrauchsstatistiken zum Vergleich bereitstellen können.
\paragraph{Sequenzen von Benutzeraktionen und Systemantworten}
siehe \ref{acc}
\paragraph{Funktionale Anforderungen}
siehe \ref{acc}
